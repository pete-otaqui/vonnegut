...
class VonnegutTest extends VonnegutTestCase
{
    ...
    public function testReflectFile() {
        ...
        $serial = $vonnegut->reflectFile(dirname(__FILE__) . "/fixtures/Fixtures/Standalone.php");
    ...
    public function testAbstractClass() {
        $vonnegut = new Vonnegut();
        require_once(dirname(__FILE__) . "/fixtures/Fixtures/Abstract/Abstract.php");
    ...
    public function testFinalClass() {
        $vonnegut = new Vonnegut();
        require_once(dirname(__FILE__) . "/fixtures/Fixtures/Final.php");
    ...
    public function testExtends() {
        $vonnegut = new Vonnegut();
        require_once(dirname(__FILE__) . "/fixtures/Fixtures/Extends.php");
        require_once(dirname(__FILE__) . "/fixtures/Fixtures/Extends/Parent.php");
        require_once(dirname(__FILE__) . "/fixtures/Fixtures/Extends/Child.php");
        require_once(dirname(__FILE__) . "/fixtures/Fixtures/Extends/Child/Grandchild.php");
    ...
    public function testMultipleClasses() {
        $vonnegut = new Vonnegut();
        require_once(dirname(__FILE__) . "/fixtures/Fixtures/Multiple.php");
    ...
    public function testGlobals() {
        $vonnegut = new Vonnegut();
        require_once(dirname(__FILE__) . "/fixtures/Fixtures/Globals.php");
